...
import qualified Data.Text.Lazy as T (unpack, concat, pack)
import           Ingscale
...
extractEither :: Text -> Either String b -> b
extractEither msg (Left  a) = error (T.unpack (T.concat [msg, ": ", (T.pack a)]))
...
number_parsing_table :: [(String, Maybe Rational)]
